...
Revision ID: 12d027525179
Revises:
Create Date: 2026-01-28 16:00:09.899955
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("MEMBER", "ADMIN", "OWNER", name="chat_participant_role_enum"),
            nullable=False,
        ),
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_chat_participants_chat_id"), "chat_participants", ["chat_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "message_type_enum",
            sa.Enum("TEXT", "VOICE", "VIDEO_NOTE", "FILE", "IMAGE", "VIDEO", name="messagetype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_messages_message_type_enum"), "messages", ["message_type_enum"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_messages_message_type_enum"), table_name="messages")
