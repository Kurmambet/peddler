...
def upgrade() -> None:
    ...
    sa.Column('message_type_enum', sa.Enum('TEXT', 'VOICE', 'VIDEO_NOTE', 'FILE', 'IMAGE', 'VIDEO', name='messagetype'), nullable=False),
    ...
    op.create_index(op.f('ix_messages_message_type_enum'), 'messages', ['message_type_enum'], unique=False)
